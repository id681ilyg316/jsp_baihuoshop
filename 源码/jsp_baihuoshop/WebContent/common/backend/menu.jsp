		   ...
		   <!--Begin 所在收货地区 Begin-->
		       ...
		       <span class="fr">
		         <c:if test="${sessionScope.currentUser==null}">
		           <span class="fl">你好，请<a href="${pageContext.request.contextPath}/Pre/login.jsp"  style="color:#ff4e00;">登录</a>&nbsp;<a href="${ctx}/Register?action=toRegister" style="color:#ff4e00;">免费注册</a>&nbsp;&nbsp;</span>
		         </c:if>
		         <c:if test="${sessionScope.currentUser!=null}">
